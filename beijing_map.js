...
// 核心数据：北京14个非遗点位（无电话字段+高德经纬度+双语完整信息）
const heritageData = [
  {
    id: 1,
  ...
  },
  {
    ...
    heritage: { zh: "庙会（东岳庙庙会）", en: "Temple Fair (Dongyue Temple Fair)" },
    ticket: { zh: "免费开放", en: "Free visit" },
  ...
  {
    id: 10,
    name: { zh: "中国工艺美术馆", en: "China National Arts and Crafts Museum, China Intangible Cultural Heritage Museum" },
...
function initAmap() {
    ...
    // 加载地图插件，渲染标注
  // 修改后（添加安全密钥配置，和index.html一致）
  AMap.plugin(['AMap.Marker'], function() {
    renderMarkers(); // 渲染所有非遗点位标注
   }, {
    securityJsCode: "98601bf6e37f842c8606a372f4a1de98" // 替换为自己的安全密钥
});
}
